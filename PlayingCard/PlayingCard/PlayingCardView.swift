...
class PlayingCardView: UIView {
    ...
    private func centeredAttributedString(_ string : String, fontSize: CGFloat) -> NSAttributedString {
        ...
        var font: UIFont = UIFont.preferredFont(forTextStyle: .body).withSize(fontSize)
    ...
    private func createCornerLabel() -> UILabel{
        let label = UILabel()
        label.numberOfLines = 0 //Initialize as many as you want
        addSubview(label)
        return label
...
extension PlayingCardView{
    private struct SizeRatio{
        ...
        static let faceCardImageSizeToBoundSize : CGFloat = 0.55
    }
